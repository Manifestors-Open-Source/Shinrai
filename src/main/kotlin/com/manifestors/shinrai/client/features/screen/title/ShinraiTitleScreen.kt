...
package com.manifestors.shinrai.client.features.screen.title

import com.manifestors.shinrai.client.Shinrai
import com.manifestors.shinrai.client.Shinrai.fullVersion
import com.manifestors.shinrai.client.features.screen.account.ShinraiAccountManager
...
class ShinraiTitleScreen : Screen(Text.of("Shinrai Title Screen")), MinecraftInstance {
    ...
    override fun init() {
        ...
        this.addDrawableChild(
            ...
            ) {  mc.setScreen(ShinraiAccountManager()) }
